...
const (
	...
	EventTypeMarketCreated           = "webhook.market.created"
	EventTypeUserPositionInitialized = "webhook.user_position.initialized"
	EventTypeMatchSettled            = "webhook.match.settled"
	EventTypeOrderStateClosed        = "webhook.order_state.closed"
	EventTypeUserPositionClosed      = "webhook.user_position.closed"
	EventTypeSettlementBatchAccepted = "webhook.settlement_batch.accepted"
	EventTypeDepositSettled          = "webhook.deposit.settled"
